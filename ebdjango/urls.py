...
urlpatterns = [
    ...
    path('admin_forgot_pass/', admin_forgot_pass),
    path('password_send_to_Admin/',password_send_to_Admin),
    ...
    path('deleteuseraccount/', deleteuseraccount),
    path('openaddproperty/', openaddproperty),
    path('saveproperty/', saveproperty),
    path('delete_property/', delete_property),
    path('openbankccountdetails/', openbankccountdetails),
    path('saveaccountdetails/', saveaccountdetails),
    path('Changebankdata/',Changebankdata),
    path('Commission/', Commission),
    path('detailofagents/', detailofagents),
    path('updatepost/', updatepost),
    path('addplot/', addplot),
    path('saveplot/', saveplot),
    path('dataofplot/', dataofplot),
    path('matarial/', matarial),
    path('mapaproval/', mapaproval),
    path('Mapaproved/', Mapaproved),
    path('downloadaprovedmap/<str:ide>/', downloadaprovedmap),
    path('savemapaproval/', savemapaproval),
    path('loan/', loan),
    path('sendloandetaial/',sendloandetaial),
    path('sendemailformatarial/', sendemailformatarial),
    path('sendemailmaterial/', sendemailmaterial),
    ...
    path('openchangeaccountdetails/',openchangeaccountdetails),
    path('changeagentpassword/', changeagentpassword),
    path('changeaadhar/', changeaadhar),
    path('txndata/', txndata),
    path('txnfail/', txnfail),
    path('testimonial/', testimonial),
    path('testimonialdatasave/', testimonialdatasave),
    path('deletetestimonial/',deletetestimonial),
    path('openmyblogs/',openmyblogs),
    path('openchangeaccountdetails/',openchangeaccountdetails),
    ...
    path('banner/',banner),
    path('bannerimg/',bannerimg),
    path('foroffr/', foroffr),
    path('openadddocuments/', openadddocuments),
    path('savedocuments/', savedocuments),
    path('delete/',delete),
    path('showdocument/', showdocument),
    path('imgforoffer/', imgforoffer),
    path('openaddpropertyvideo/',openaddpropertyvideo),
    path('savepropertyvideos/', savepropertyvideos),
